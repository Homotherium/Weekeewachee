...
/**
  ...
  */
QVector3D GLBody::setCenter(const QVector3D & newVal)
{
    QVector3D result;

    if(newVal.x() >6){
        result.setX(7.5);
    } else if(newVal.x() <6 && newVal.x() >3){
        result.setX(4.5);
    } else if(newVal.x() <3 && newVal.x() >0){
        result.setX(1.5);
    } else if(newVal.x() <0 && newVal.x() >-3.0){
        result.setX(-1.5);
    } else if(newVal.x() <-3.0 && newVal.x() >-6){
        result.setX(-4.5);
    } else if(newVal.x() <-6.0){
        result.setX(-7.5);
    }

    if(newVal.y() >3){
        result.setY(4.5f);
    } else if(newVal.y() <3 && newVal.y() >0){
        result.setY(1.5f);
    } else if(newVal.y() <0 && newVal.y() >-3.0){
        result.setY(-1.5f);
    } else if(newVal.y() <-3.0){
        result.setY(-4.5f);
    }
    ...
    /*
    qDebug() << "Test1 set Center";
    m_center = newVal;
    qDebug() << "Test2 set Center";
    m_surfaceIsValid = false;
    qDebug() << "Test3 set Center";
    */
}
